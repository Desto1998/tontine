                ...
                <form action="#" id="save-form_{{ $value->id }}" method="post" onsubmit="saveEditedData({{ $value->id }})">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 mb-3"><div class="form-group col-md-6 mb-3">
                                <label for="first_name_{{ $value->id }}">Nom d'un membre<span class="text-danger">*</span></label>
                                <input type="text" name="first_name" value="{{ $value->first_name }}" id="first_name_{{ $value->id }}" class="form-control" required autocomplete="first_name">
                                <div id="first_name-error_{{ $value->id }}" class="text-danger error-display" role="alert"></div>
                            </div>

                            <label for="last_name_{{ $value->id }}">Prenom du membre<span class="text-danger">*</span></label>
                            <input type="text" name="last_name" value="{{ $value->last_name }}" id="last_name_{{ $value->id }}" class="form-control" required autocomplete="last_name">
                            <div id="last_name-error_{{ $value->id }}" class="text-danger error-display" role="alert"></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" maxlength="14" minlength="9" value="{{ $value->phone }}" name="phone" id="phone_{{ $value->id }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="fund_amount_{{ $value->id }}">Fond a verser <span class="text-danger"></span></label>
                                <input type="number" name="fund_amount" value="{{ $value->fund_amount }}" id="fund_amount_{{ $value->id }}" class="form-control"
                                       autocomplete="fund_amount" step="any">
                                <div id="fund_amount-error_{{ $value->id }}" class="text-danger error-display" role="alert"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group col-md-6 mb-3">
                                ...
                                <input type="text" name="city" id="city_{{ $value->id }}" value="{{ $value->city }}" class="form-control" required autocomplete="city">
                                <div id="city-error_{{ $value->id }}" class="text-danger error-display" role="alert"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="address_{{ $value->id }}">Adresse <span class="text-danger">*</span></label>
                                <input type="text" name="address" value="{{ $value->address }}" id="address_{{ $value->id }}" class="form-control" required
