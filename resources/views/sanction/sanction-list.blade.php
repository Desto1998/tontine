    ...
    <div class="container-fluid">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>GESTION DES SANCTION</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active"><a href="#">Associations</a></li>
                            <li class="breadcrumb-item active"><a href="#">Sanctions</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajouter un sanction</h4>
                ...
                <div class="modal-body">
                    <form action="#" id="save-form" method="post">
                        <div class="form-group mb-3">
                            <label for="title">Titre de la sanction<span class="text-danger">*</span></label>
                            <input type="text" name="title" id="title" class="form-control" required
                                   autocomplete="title">
                            <div id="title-error" class="text-danger error-display" role="alert"></div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="description">Description<span class="text-danger">*</span></label>
                            <textarea  name="description" id="title" class="form-control" required
